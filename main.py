...
from code.visualise import correlation_matrix, scatter_plot, confusion_matrix
from code.classifier import MLTrainer

def main() -> None:

    ## Control
    algorithm_selection: int = 3
    ...
    y_pred = np.array(fruit_classifier.get_classifier_pred()) + 1
